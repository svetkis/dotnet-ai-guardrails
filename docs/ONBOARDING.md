...
1. Скопируй [`rules/AGENTS.md`](../rules/AGENTS.md) в корень своего проекта
...
| **AGENTS.md из другого проекта** | Правила про чужой стек вводят команду в заблуждение | Напиши свой, используя [`rules/AGENTS.md`](../rules/AGENTS.md) как шаблон |
