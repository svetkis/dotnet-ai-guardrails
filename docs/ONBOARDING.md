...
| **Standard** | 1–2 недели | Слои 0→2 + 2–3 аудита | Основной сценарий. Большинство проектов начинают здесь. |
| **Paranoid** | 3–4 недели | Все слои + внешний цикл + груминг артефактов | Проект с высокими рисками (fintech, health, high-load). |
...
| **Клонирование DemoProject** | Агент создаёт `examples/DemoProject/` в целевом репо, копируя структуру из `dotnet-skeptical-ai` | `examples/` — это демонстрация методологии, не шаблон для копирования. Не создавай демо-проекты в рабочем репо. |
