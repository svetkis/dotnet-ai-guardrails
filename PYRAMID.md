...
Любой guardrail — Roslyn-анализатор, архитектурная проверка, тест, regex по артефактам или линтер-правило — должен отвечать на вопрос: **«Какой конкретный баг это ловит?»**
