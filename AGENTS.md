...
- НЕ копируй его структуру папок (`rules/`, `skills/`, `examples/`, `tests/patterns/`) в целевой проект.
...
| Осознанные отклонения (Decision Guards / ADR) | `skills/skeptical-ai-bootstrap/DECISION-GUARDS.md` |
