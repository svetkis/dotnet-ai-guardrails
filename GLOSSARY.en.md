...
|------|------------|---------|
| **Layer 1 (development cycle)** | Fast feedback: Compiler → Architecture → Tests → Code Review → Smoke. Runs on every change, from seconds to minutes. | [PYRAMID.md §Layer 1](PYRAMID.md#layer-1) |
| **Outer loop** | Final human verification, business and product decisions. Not part of the daily feedback loop. | [PYRAMID.md §Outer loop](PYRAMID.md#outer-loop) |
| **Layer 0** | Instructions for the agent: `AGENTS.md` + numbered decisions. The agent reads before code. | [PYRAMID.md §Layer 0](PYRAMID.md#layer-0) |
